...
def _flush_segment(
    ...
    *,
    ...
    #
    # SCOPE: this notice covers BOTH rewriters that run on this pasteable
    # assistant body -- `redact_credentials` (issue #6189) and
    # `redact_exfiltration_urls` (issue #8132), worded by kind because the
    # remedies differ. Other `redact_exfiltration_urls` call sites in this module
    # (titles, tool names, feed strings, stashed variants) stay notice-free on
    # purpose: they do not produce text the user copies commands from.
